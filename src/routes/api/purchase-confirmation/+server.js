...
export async function POST({ request }) {
    ...
    const customerEmail = requestBody.data.object.customerEmail;
    const customerName = requestBody.data.object.customerName;
    
    const message = {
        to: customerEmail,
        from: "jolitp@gmail.com",
        subject: "Your Purchase Confirmation - Complete Spain Relocation Guide",
        html: `
        <h1>Thank You for Your Purchase!</h1>
        <p>Dear ${customerName},</p>
        <p>We appreciate your purchase of the <strong>Complete Spain Relocation Guide</strong>. We're confident that this ebook will provide you will ...
